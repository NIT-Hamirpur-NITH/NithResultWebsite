  ...
  var request = http.request({
    ...
    function(res,err) {
      ...
      */
        ...
        var dataByRollNumber = {};
        var key = rollnumber;
        dataByRollNumber[key] = metadata;

        console.log(dataByRollNumber);


        fs.appendFile('result.json', JSON.stringify(dataByRollNumber,null,4)  + ',\n', function (err) {
          if (err){
            console.log(err);
          }
          callback();
