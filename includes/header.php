...
<div class="span10 offset1">
	...
	<div class="modal hide fade" id="my-modal">
		...
		<div class="modal-body lead">
			<p>I had learnt some of the basics of php and mysql during the summer
	...
	<div class="modal hide fade" id="my-modal2">
		...
		<div class="modal-body lead">
			<p>The design of this website is created with Twitter Bootstrap CSS Framework
	...
	<div class="modal hide fade" id="my-modal3">
		...
		<div class="modal-body lead">
			<p>There are always some ideas popping up in my head , but i don't have resources
