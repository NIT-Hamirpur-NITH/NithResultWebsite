...
?>
  <div class="span9 offset1" style="color:#333; font-family:Lobster, cursive; padding: 20px 40px; border-radius: 5px;
           box-shadow:2px 2px 5px green, -1px -1px 2px green; font-size:25px; margin-bottom:20px; text-align:center; background:#A0FFA0;">
...
?>
  ...
  <div class="span9 offset1" style="color:#333; font-family:Lobster, cursive; padding: 20px 40px; border-radius: 5px;
           box-shadow:2px 2px 5px red, -1px -1px 2px red; font-size:25px; margin-bottom:20px; text-align:center; background:#FFD0D0;">
